...
{
    public partial class ApplicationUserDtoGen : GeneratedDto<Wedding.Data.Models.ApplicationUser>
    {
        ...
        /// </summary>
        public override void MapFrom(Wedding.Data.Models.ApplicationUser obj, IMappingContext context, IncludeTree tree = null)
        {
            if (obj == null) return;
        ...
        /// </summary>
        public override void MapTo(Wedding.Data.Models.ApplicationUser entity, IMappingContext context)
        {
            var includes = context.Includes;
